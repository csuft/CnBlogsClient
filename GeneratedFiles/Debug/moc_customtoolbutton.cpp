...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CustomToolButton_t, stringdata) + ofs \
...
const QMetaObject CustomToolButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_CustomToolButton.data,
      qt_meta_data_CustomToolButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomToolButton.stringdata))
