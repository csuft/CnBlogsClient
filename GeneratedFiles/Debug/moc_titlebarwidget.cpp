...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TitleBarWidget_t, stringdata) + ofs \
...
const QMetaObject TitleBarWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TitleBarWidget.data,
      qt_meta_data_TitleBarWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TitleBarWidget.stringdata))
